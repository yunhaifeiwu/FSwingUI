 ...
 * @author cloud
 */
public class CrystalPaint1 extends AbstractPaint{
    
    public CrystalPaint1(){
        super();
    ...
    protected void paintImp(Graphics g, JComponent c) {
        ...
        switch(azimuth){
            case 0://从上到下渐变
                ...
                g2.fillRect(0,0,w ,Math.round( h*highlightRatio));           
                break;
            case 1://从左到右
        ...
        alpha2 = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 1f);
        g2.setComposite(alpha2);
    ...
    protected void setParameter() {
        try {
            ...
            super.addParameter("alpha","透明度",0.7f);
            
        } catch (Exception ex) {
            Logger.getLogger(CrystalPaint1.class.getName()).log(Level.SEVERE, null, ex);
        }
        
    }
    
    public static void main(String[] args) throws Exception{
         AbstractPaint paint =new CrystalPaint1 ();
