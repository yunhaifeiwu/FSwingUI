 ...
 * @author cloud
 */
public class PropertyChangeBindTest1 {
...
//                 no="由"+evt.getOldValue()+"变成"+evt.getNewValue(); 
        ...
        public void xEvent(PropertyChangeEvent evt){}
    }
    ...
    public void run(){        
        ...
        sdt.addPropertyChangeListener(new UseCase(sdt){
            @Override
            public void xEvent(PropertyChangeEvent evt){
    ...
    public static void main(String args[]) {
        PropertyChangeBindTest1 ma=new PropertyChangeBindTest1();
        ma.run();
